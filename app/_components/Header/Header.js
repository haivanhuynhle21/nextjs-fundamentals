    ...
    <header className={"short-header"}>
      ...
      <div className="row header-content">
          ...
          <ul className="main-navigation sf-menu">
            {MENU_HEADER_ITEMS.map((item, index) => {
              return (
                <li
                  key={index}
                  {...(item.children && { className: "has-children" })}
                ...
                >
                  ...
                  {item.children && (
                    <ul
                      ...
                      style={{
                        display:
                          childMenuActive === item.name ? "block" : "none",
                      }}
                    >
        ...
        <div className="search-wrap">
          ...
          <a className="close-btn" onClick={() => setSearchVisible(false)}>
            Close
          </a>
        </div>
        <div className="triggers">
          <a className="search-trigger" onClick={() => setSearchVisible(true)}>
